...
$lang['about_app'] = 'O aplikaci @webScheduler';
...
$lang['about_app_info'] = '@webScheduler je vysoce přizpůsobitelná webová aplikace, která vašim zákazníkům umožňuje rezervovat si s vámi schůzky prostřednictvím webu. Navíc poskytuje možnost synchronizovat vaše data s Kalendářem Google, takže je můžete využívat v rámci dalších služeb.';
$lang['current_version'] = 'Aktuální verze';
$lang['support'] = 'Podpora';
$lang['about_app_support'] = 'Pokud při používání @webScheduler narazíte na jakékoli problémy, můžete odpovědi hledat v oficiální skupině Google. Také můžete založit nový incident na stránce Google Code za účelem podpory dalšího vývoje.';
...
$lang['about_app_license'] = '@webScheduler je licencováno pod licencí GPLv3. Používáním kódu @webScheduler v jakékoli formě souhlasíte s podmínkami popsanými v dokumentu na následující adrese:';
...
$lang['ea_update_success'] = 'Aplikace @webScheduler byla úspěšně aktualizována.';
...
$lang['api_token_hint'] = 'Nastavte bezpečnostní token, abyste povolili autentizaci tokenem v API @webScheduler.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API vám umožňuje interagovat se všemi daty @webScheduler prostřednictvím HTTP protokolu a dostupných API koncových bodů a vytvářet vlastní integrace.';
