...
$lang['about_app'] = 'Apie @webScheduler';
...
$lang['about_app_info'] = '@webScheduler - tai labai lengvai pritaikoma žiniatinklio programa, leidžianti jūsų klientams užsisakyti susitikimus su jumis internetu. Be to, ji suteikia galimybę sinchronizuoti duomenis su "Google" kalendoriumi, todėl galite juos naudoti su kitomis paslaugomis.';
$lang['current_version'] = 'Dabartinė versija';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'Jei naudodamiesi "@webScheduler" susidursite su kokiomis nors problemomis, atsakymų galite ieškoti oficialioje "Google" grupėje. Taip pat gali tekti sukurti naują problemą "Google Code" puslapyje, kad padėtumėte vystyti programą.';
...
$lang['about_app_license'] = '@webScheduler yra licencijuota pagal GPLv3 licenciją. Bet kokiu būdu naudodami @webScheduler kodą, jūs sutinkate su sąlygomis, aprašytomis šiame url adrese:';
...
$lang['ea_update_success'] = '@webScheduler sėkmingai atnaujinta.';
...
$lang['api_token_hint'] = 'Nustatykite slaptą simbolį, kad įjungtumėte "@webScheduler" API autentifikavimą pagal simbolį.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API leidžia jums bendrauti su visais "@webScheduler" duomenimis per HTTP protokolą ir galimus API galinius taškus bei kurti savo integracijas.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Ši integracija leidžia prisijungti prie esamo LDAP serverio ir automatiškai importuoti naudotojus į "@webScheduler" bei leisti jiems SSO su jų katalogo slaptažodžiu (naudotojo vardas turi sutapti).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
