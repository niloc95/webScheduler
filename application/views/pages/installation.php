...
<header>
    <div class="container">
        <h1 class="page-title">@webScheduler Installation</h1>
    </div>
</header>

<div class="content container">
    <div class="welcome">
        <h3>Welcome to the @webScheduler installation page.</h3>
        <p>
            This page will help you set the main settings of your @webScheduler installation. You will be able to
    ...
    <div class="mb-2">
        <h3>License</h3>
        @webScheduler is licensed under the <span class="badge bg-secondary">GPL-3.0 license</span>. By using the
        code
        of @webScheduler in any way <br> you agree with the terms described in the following url:
